...
## Project Structure
    ...
    ├── testapiautocatalog_103751  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_103751`
...
2. Clone this repo and `cd testapiautocatalog_103751`
